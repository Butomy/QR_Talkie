...
class Circleprogress extends StatefulWidget {
  ...
  @override
  CircleprogressState createState() {
    return CircleprogressState();
  }
}

class CircleprogressState extends State<Circleprogress>
  ...
  @override
  void didUpdateWidget(Circleprogress oldWidget) {
...
class CircleprogressPainter extends CustomPainter {
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    final oldPainter = (oldDelegate as CircleprogressPainter);
