            ...
            children: [
              EasyStepper(direction: Axis.horizontal,
                ...
                steps: [
                  ...
                  EasyStep(
                    customStep: CircleAvatar(radius: 14.r,
                      backgroundColor:
              ...
              IndexedStack(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(margin: const EdgeInsets.only(top: 9.93),
                          padding: const EdgeInsets.only(top: 18.49,
                              bottom: 17.6,
                              left: 16.91,
                              right: 20.3),
                          ...
                          child:Row(
                            ...
                            children: [
                              ...
                              ),     Radio(value: "1", groupValue: RadioValue, onChanged: (index) {
                                setState(() {
                                  RadioValue=index.toString();
                                });
                              },toggleable: true,activeColor: primaryColor,),
                  ...
                  const Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: 21,left: 21,right: 21,bottom: 8),
                  ...
                  const Column(children: [Text("Payment")],)
